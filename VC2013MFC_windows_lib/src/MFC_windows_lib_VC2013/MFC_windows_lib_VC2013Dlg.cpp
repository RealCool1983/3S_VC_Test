...
// MFC_windows_lib_VC2013Dlg.cpp : implementation file
//

#include "stdafx.h"
#include "MFC_windows_lib_VC2013.h"
#include "MFC_windows_lib_VC2013Dlg.h"
...
CMFC_windows_lib_VC2013Dlg::CMFC_windows_lib_VC2013Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CMFC_windows_lib_VC2013Dlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CMFC_windows_lib_VC2013Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CMFC_windows_lib_VC2013Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//ON_WM_DEVICECHANGE()
...
// CMFC_windows_lib_VC2013Dlg message handlers

BOOL CMFC_windows_lib_VC2013Dlg::OnInitDialog()
{
...
void CMFC_windows_lib_VC2013Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMFC_windows_lib_VC2013Dlg::OnPaint()
{
	if (IsIconic())
	{
...
HCURSOR CMFC_windows_lib_VC2013Dlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}


LRESULT CMFC_windows_lib_VC2013Dlg::OnMyDeviceChange(WPARAM wParam, LPARAM lParam)
{
...
void CMFC_windows_lib_VC2013Dlg::UpdateDevice(PDEV_BROADCAST_DEVICEINTERFACE pDevInf, WPARAM wParam)
{
	// pDevInf->dbcc_name: 
...
BOOL CMFC_windows_lib_VC2013Dlg::FindDevice(HDEVINFO& hDevInfo,
	CString& szDevId,
	SP_DEVINFO_DATA& spDevInfoData)
{
...
CString CMFC_windows_lib_VC2013Dlg::GetClassDesc(const GUID* pGuid)
{
	TCHAR buf[MAX_PATH];
	DWORD size;
...
int CMFC_windows_lib_VC2013Dlg::GetClassImgIndex(const GUID* pGuid)
{
	int nIdx;
...
HTREEITEM CMFC_windows_lib_VC2013Dlg::GetClassItem(const GUID* pGuid, WPARAM wParam)
{
...
void CMFC_windows_lib_VC2013Dlg::OnContextMenu(CWnd* pWnd, CPoint point)
{
...
void CMFC_windows_lib_VC2013Dlg::OnPopupDisable()
{
