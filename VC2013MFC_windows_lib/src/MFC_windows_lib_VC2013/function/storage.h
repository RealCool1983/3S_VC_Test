...
typedef int (__stdcall *FMSDC_ReadSectorW)(IN WCHAR Drive, IN HANDLE hDrive, IN DWORD StartSector, IN DWORD SectorCount, OUT VOID *pBuffer);
...
typedef int (__stdcall *FMSDC_ReadSectorExW)(IN WCHAR Drive, IN HANDLE hDrive, IN DWORD StartSector, IN DWORD SectorCount, OUT VOID *pBuffer);
...
typedef int (__stdcall *FMSDC_WriteSectorW)(IN WCHAR Drive, IN HANDLE hDrive, IN DWORD StartSector, IN DWORD SectorCount, IN VOID *pBuffer);
...
typedef int (__stdcall *FMSDC_TestUnitReadyW)(IN WCHAR Drive, IN HANDLE hDrive);
...
typedef int (__stdcall *FMSDC_DismountVolumeW)(IN WCHAR Drive, IN HANDLE hDrive);
int __stdcall MSDC_DismountVolumeW(IN WCHAR Drive, IN HANDLE hDrive);

typedef int (__stdcall *FMSDC_ReMountVolumeW)(IN WCHAR Drive, IN HANDLE hDrive);
int __stdcall MSDC_ReMountVolumeW(IN WCHAR Drive, IN HANDLE hDrive);

typedef int (__stdcall *FMSDC_FormatW)(WCHAR Drive, WCHAR FatType[], WCHAR Label[], DWORD ClusterSize);
int __stdcall MSDC_FormatW(WCHAR Drive, WCHAR FatType[], WCHAR Label[], DWORD ClusterSize);

typedef int (__stdcall *FMSDC_FormatWithCallbackW)(WCHAR Drive, WCHAR FatType[], WCHAR Label[], DWORD ClusterSize, FMSDC_FormatCallBack pCallback);
...
typedef int (__stdcall *FMSDC_LockVolumeW)(IN WCHAR Drive, IN HANDLE hDrive);
...
typedef int (__stdcall *FMSDC_ReadSectorA)(IN CHAR Drive, IN HANDLE hDrive, IN DWORD StartSector, IN DWORD SectorCount, OUT VOID *pBuffer);
int __stdcall MSDC_ReadSectorA(IN CHAR Drive, IN HANDLE hDrive, IN DWORD StartSector, IN DWORD SectorCount, OUT VOID *pBuffer);

typedef int (__stdcall *FMSDC_ReadSectorExA)(IN CHAR Drive, IN HANDLE hDrive, IN DWORD StartSector, IN DWORD SectorCount, OUT VOID *pBuffer);
...
typedef int (__stdcall *FMSDC_WriteSectorA)(IN CHAR Drive, IN HANDLE hDrive, IN DWORD StartSector, IN DWORD SectorCount, IN VOID *pBuffer);
int __stdcall MSDC_WriteSectorA(IN CHAR Drive, IN HANDLE hDrive, IN DWORD StartSector, IN DWORD SectorCount, IN VOID *pBuffer);

typedef int (__stdcall *FMSDC_TestUnitReadyA)(IN CHAR Drive, IN HANDLE hDrive);
...
typedef int (__stdcall *FMSDC_GetScsiStringsA)(IN CHAR Drive, IN HANDLE hDrive, OUT CHAR *pVendorString, OUT CHAR *pProductString);
int __stdcall MSDC_GetScsiStringsA(IN CHAR Drive, IN HANDLE hDrive, OUT CHAR *pVendorString, OUT CHAR *pProductString);

typedef int (__stdcall *FMSDC_GetPhysicalDriveNumberA)(IN CHAR Drive, IN HANDLE hDrive, OUT DWORD *pPhysicalDriveNumber);
...
typedef int (__stdcall *FMSDC_DismountVolumeA)(IN CHAR Drive, IN HANDLE hDrive);
int __stdcall MSDC_DismountVolumeA(IN CHAR Drive, IN HANDLE hDrive);

typedef int (__stdcall *FMSDC_ReMountVolumeA)(IN CHAR Drive, IN HANDLE hDrive);
int __stdcall MSDC_ReMountVolumeA(IN CHAR Drive, IN HANDLE hDrive);

typedef int (__stdcall *FMSDC_FormatA)(CHAR Drive, CHAR FatType[], CHAR Label[], DWORD ClusterSize);
int __stdcall MSDC_FormatA(CHAR Drive, CHAR FatType[], CHAR Label[], DWORD ClusterSize);

typedef int (__stdcall *FMSDC_FormatWithCallbackA)(CHAR Drive, CHAR FatType[], CHAR Label[], DWORD ClusterSize, FMSDC_FormatCallBack pCallback);
...
typedef int (__stdcall *FMSDC_LockVolumeA)(IN CHAR Drive, IN HANDLE hDrive);
